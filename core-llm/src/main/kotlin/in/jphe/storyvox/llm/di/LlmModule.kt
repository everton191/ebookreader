...
import `in`.jphe.storyvox.llm.local.GemmaDiagnostics
...
object LlmModule {
    ...
    @Provides
    @Singleton
    fun provideLocalAiProvider(installer: LocalGemmaModelInstaller, diagnostics: GemmaDiagnostics): LocalAiProvider =
        LiteRtGemmaAiProvider(installer, diagnostics)
